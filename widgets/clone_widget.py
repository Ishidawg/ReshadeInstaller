...
class CloneShaderWidget(QWidget):
    ...
    def __init__(self):
        ...
        l_prod80 = QLabel(
            "Highly advanced Color Effects, constrast, brightness...")
    ...
    def process_cloning(self):
        selections = []
        if self.ch_default.isChecked():
            selections.append("default")
        if self.ch_prod80.isChecked():
            selections.append("prod80")
        if self.ch_quint.isChecked():
            selections.append("quint")
